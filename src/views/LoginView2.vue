...
<main class="main">
	<div class="container">
		<section class="wrapper">
			<div class="heading">
				<h1 class="text text-large">Log In</h1>
			...
			<div class="form">
				<div class="mb-4">
					<label for="email" class="input-label fw-semibold mb-1 ml-3">Email Address<span class="text-danger">*</span></label>
				...
				<div class="input-control">
                    ...
                    <input  v-on:click="loginWithEmail()" type="submit" name="submit" class="input-submit mt-3 w-100 d-flex align-items-center justify-content-center" value="Log In">
				</div>
			</div>
			<div class="striped">
...
const loginWithEmail = () => { // we also renamed this method
    firebase
      .auth()
